...
import { selectmodalsState } from '@/lib/features/modals/modalsSlice'

const DeleteModal = (): JSX.Element => {
  // const { isDeleteEvent } = useAppSelector(selectmodalsState)
  const test = useAppSelector((state) => state.modals.isDeleteEvent)
